...
FILENAME_DATIM_DATA_ELEMENTS = 'data/datim_dataElements_20210106.json'
FILENAME_DATIM_COCS = 'data/datim_categoryOptionCombos_20210106.json'
FILENAME_DATIM_INDICATORS = 'data/datim_indicators_20210106.json'
FILENAME_DATIM_CODELISTS_WITH_EXPORT = (
    'data/codelist_collections_with_exports_FY16_21_20210106.json')
FILENAME_IHUB = 'data/ihub_mer_derived_data_rules_20210108.csv'
