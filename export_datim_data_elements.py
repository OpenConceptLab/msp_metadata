...
url_dhis2_data_element_all = 'https://dev-de.datim.org/api/dataElements.json?fields=id,code,name,shortName,aggregationType,domainType,description,valueType,categoryCombo[id,code,name,categoryOptionCombos[id,code,name]],dataElementGroups[id,name],attributeValues,dataSetElements[dataSet[id,name,shortName]]'
...
# Set the request URL
url = url_dhis2_data_element_all + option_paging
